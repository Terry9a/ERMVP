...
def load_saved_model_rl(saved_path, model, epoch=None):
    """
    ...
    def findLastCheckpoint(save_dir):
        ...
        if file_list:
            ...
            for file_ in file_list:
                result = re.findall("rl_net_epoch(.*).pth.*", file_)
    ...
    if os.path.exists(os.path.join(saved_path, 'net_latest.pth')):
        ...
        state_dict_ = torch.load(os.path.join(saved_path, 'rl_net_epoch%d.pth' % initial_epoch))
        state_dict = {}
