...
def test_parser():
    ...
    parser.add_argument('--model_dir', type=str, default='/home/gaojing/zjy/cvpr/V2V4Real/opencood/logs/corpbevtlidar_2024_09_03_10_29_12',
    ...
    parser.add_argument('--eval_epoch', type=str, default=53,
